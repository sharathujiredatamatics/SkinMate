//
//  EditFamilyMemberViewControllerExtension.swift
//  SkinMate
//
...
import UIKit
// Extension for validate all textfields of the Edit Family view.
extension EditFamilyMemberViewController : UITextFieldDelegate {
    ...
    func validCredentials() {
        if  validPhone == true || validEName == true || validInsurance == true || validAddress == true {
