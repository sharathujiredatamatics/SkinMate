...
import CoreLocation
import DropDown
// Class to manage User Upadte view.
class UserUpdateViewController: UIViewController, UITextViewDelegate, CLLocationManagerDelegate{
    ...
    // Function to add user details to textfields.
    func  addDetails(){
        ...
        txtDate.text = dob
        txtAddress.text = UserDetails.shared.address
    ...
    // TextField functions to check did begin and did end.
    ...
    // Function apply designs to blood text field, gender and date of birth field.
    func applyDesign() {
        self.imgSelected.isHidden = true
        self.FemaleSelected.isHidden = true
        self.OtherSelected.isHidden = true
    ...
    // Function to update user deatils.
    @objc func createAccount() {
        ...
        UserDetailsUpdate.shared.userUpdateDetails(address: txtAddress.text!, insurance: txtInsur.text!, eName: txtContact.text!, eNumber: txtNumber.text!)
    }
    // Function to load success view after user upadte details success.
