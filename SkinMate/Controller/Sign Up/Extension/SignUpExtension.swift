...
extension  SignupViewController {
    ...
    func checkPhone(){
        ...
        if txtPhone.text == "" {
            lblPhoneError.text = "Please enter password"
            txtPhone.layer.borderWidth = 0.50
            ...
            lblPhoneError.text = ""
            txtPhone.layer.borderWidth = 0.15
            txtPhone.layer.masksToBounds = true
    ...
    func checkEmail(){
        ...
        if txtEmail.text == "" {
            ...
            txtEmail.layer.borderWidth = 0.50
            ...
            lblEmailError.text = ""
            txtEmail.layer.borderWidth = 0.15
            txtEmail.layer.masksToBounds = true
    ...
    func checkPass(){
        ...
        if txtPassword.text == "" {
            ...
            txtPassword.layer.borderWidth = 0.50
            ...
            lblPassError.text = ""
            txtPassword.layer.borderWidth = 0.15
            txtPassword.layer.masksToBounds = true
    ...
    func confirmPass(){
        ...
        if txtConfirm.text == "" {
            ...
            txtConfirm.layer.borderWidth = 0.50
            ...
            txtConfirm.layer.borderWidth = 0.15
            txtConfirm.layer.masksToBounds = true
