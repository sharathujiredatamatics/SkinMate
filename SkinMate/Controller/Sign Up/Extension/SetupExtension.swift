...
extension SetProfileViewController: UITextFieldDelegate {
    ...
    @objc func keyboardWillHide(notification: NSNotification) {
        ...
        func checkFirstName(){
            if txtFirst.text == ""{
                txtFirst.layer.borderWidth = 0.50
                ...
                txtFirst.layer.borderWidth = 0.15
                txtFirst.layer.masksToBounds = true
        ...
        func checkLastName(){
            if txtLast.text == ""{
                ...
                txtLast.layer.borderWidth = 0.15
                txtLast.layer.masksToBounds = true
    ...
    func validCredentials() {
        if  validPhone == true && validEName == true && validInsurance == true && validFirstName == true && valilidLastName == true {
